                    ...
                    <SectionContainer className="hero--container flex flex-col gap-8 mt-32">
                        ...
                        <div className="content-container">
                            ...
                            <div class="buttons-container mt-6 mb-4 flex flex-wrap gap-2">
                                ...
                                <a href="https://github.com/NinadVyas/" rel="noreferrer" class="bg-[#363636] py-1 rounded-lg px-1 flex align-center flex-[0,0,auto] justify-center text-sm text-white-300 h-fit flex-row hover:bg-neutral-600 transition-colors duration-300" target="_blank" title="Follow Christian Luntok | Avenue Labs on Github">
                                ...
                                </a><a href="https://www.linkedin.com/in/ninadvyas/" rel="noreferrer" class="bg-[#363636] py-1 rounded-lg px-1 flex align-center flex-[0,0,auto] justify-center text-sm text-white-300 h-fit flex-row hover:bg-neutral-600 transition-colors duration-300" target="_blank" title="Follow Christian Luntok | Developer &amp; Designer on LinkedIn">
                                ...
                                </a><a href="mailto:ninadvyas07@gmail.com" rel="noreferrer" class="bg-[#363636] py-1 rounded-lg px-1 flex align-center flex-[0,0,auto] justify-center text-sm text-white-300 h-fit flex-row hover:bg-neutral-600 transition-colors duration-300" target="_blank" title="Send an email to Christian Luntok | Developer &amp; Designer">
                                ...
                                </a><a href="https://twitter.com/ninadvsd/" rel="noreferrer" class="bg-[#363636] py-1 rounded-lg px-1 flex align-center flex-[0,0,auto] justify-center text-sm text-white-300 h-fit flex-row hover:bg-neutral-600 transition-colors duration-300" target="_blank" title="Follow Christian Luntok | Avenue Labs on Twitter">

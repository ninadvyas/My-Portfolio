    ...
    <Timeline>
      <TimelineEvent active>
        ...
        <TimelineEvent.Description>
          ...
          principles, pixel perfect, clean architecture, clean code and using
          microfrontends and storybook practices to facilitate the use of
          reusable components using the following technologies and tools: Jira,
          SCRUM, Git, Github, Bitbucket, HTML, CSS, SASS, Tailwind, JavaScript,
          TypeScript, React, Next.js, Redux, Jest, Storybook, GitFlow and
          Microfrontends concepts and practices.
        </TimelineEvent.Description>
      </TimelineEvent>

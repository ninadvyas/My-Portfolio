...
const Footer = () => {
  return (
    <footer className='w-full lg:min-w-xs lg:max-w-screen-md flex flex-col justify-center items-center mx-auto mb-4
    '>
      ...
      <AnimationContainer customClassName='w-full max-w-2xl grid place-items-center grid-cols-3 gap-1 lg:gap-4 pb-8 sm:grid-cols-3 mx-3'>
        ...
        <ExternalLink href='https://www.linkedin.com/in/ninad-vyas-b767491a3/'>
        ...
        <div className='flex flex-col space-y-4'>
          ...
          <ExternalLink href='https://github.com/NinadVyas'>
            <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='currentColor' className='w-5 h-5'>
        ...
        <div className='flex flex-col space-y-4'>
        <ExternalLink href='https://twitter.com/NinadVyas87'>
